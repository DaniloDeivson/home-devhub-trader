...
export function SubscriptionPage() {
  ...
  const plans: Plan[] = [
    ...
    },
    {
      ...
      features: [
        ...
        'Análise de backtest intermediária',
        'Acesso à comunidade',
        '5.000 tokens/mês',
        'Suporte por email'
      ]
  ...
  const handleUpgradeClick = (planId: string) => {
    ...
    switch(planId) {
      case 'pro1':
        message = `Olá vim do DevHub Trader e quero mais informações e ajuda para fazer upgrade para o plano PRO 1 (R$ 259,80/mês).`;
        break;
      case 'pro2':
        message = `Olá vim do DevHub Trader e quero mais informações e ajuda para fazer upgrade para o plano PRO 2 (R$ 499,80/mês).`;
        break;
      case 'pro3':
        message = `Olá vim do DevHub Trader e quero mais informações e ajuda para fazer upgrade para o plano PRO 3 (R$ 999,80/mês).`;
        break;
      default:
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {plan.id === 'pro2' && <Star className="w-5 h-5 text-yellow-500" />}
